...
fstride=10
tstride=10
base_exp_dir=./exp/test-${dataset}-imp$imagenetpretrain-asp$audiosetpretrain-b$batch_size-lr${lr}_TL_pure
...
CUDA_VISIBLE_DEVICES=0 CUDA_CACHE_DISABLE=1 python -W ignore ../../src/run_mtg.py --model ${model} --dataset ${dataset} \
  --exp-dir $exp_dir \
  --n_class 56 \
